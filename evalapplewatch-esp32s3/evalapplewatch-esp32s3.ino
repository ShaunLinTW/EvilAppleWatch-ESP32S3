...
void loop()
{
    ...
    if (device_choice == 0){
      ...
      String deviceData = String((char*)DEVICES[index], 31);
      oAdvertisementData.addData(deviceData);
    } else {
      int index = random(13);
      // oAdvertisementData.addData(std::string((char*)SHORT_DEVICES[index], 23));
      String shortDeviceData = String((char*)SHORT_DEVICES[index], 23);
      oAdvertisementData.addData(shortDeviceData);
    }
